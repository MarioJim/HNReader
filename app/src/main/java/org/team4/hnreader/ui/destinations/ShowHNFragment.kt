...
import org.team4.hnreader.ui.fragments.ShowHNFragmentDirections

class ShowHNFragment : Fragment(), StoryRecyclerViewCallbacks {
    ...
    override fun openStoryDetails(story: Story) {
        val directions = ShowHNFragmentDirections.actionShowHNFragmentToStoryDetailsFragment(story)
